...
export class TestdataProvider {
    ...
    static getModel3(): Model {
        const elements: Element[] = [
            { id: 'StartEvent_1t34b5j', name: 'Application submitted (As)', type: ElementType.START, incomingFlows: [], outgoingFlows: ['0'] },
            { id: 'Activity_1ujl89c', name: 'Decline application (Da1)', type: ElementType.TASK, incomingFlows: ['1'], outgoingFlows: ['2'] },
            { id: 'Activity_1f7vwaw', name: 'Accept application (Aa)', type: ElementType.TASK, incomingFlows: ['3'], outgoingFlows: ['4'] },
            { id: 'Activity_1srex89', name: 'Finalize application (Fa)', type: ElementType.TASK, incomingFlows: ['5'], outgoingFlows: ['6'] },
            { id: 'Activity_1tgknny', name: 'Select and send offer (Sso)', type: ElementType.TASK, incomingFlows: ['9'], outgoingFlows: ['10'] },
            { id: 'Activity_0r9antn', name: 'Receive offer (Ro)', type: ElementType.TASK, incomingFlows: ['10'], outgoingFlows: ['11'] },
            { id: 'Activity_1q88w1a', name: 'Cancel offer (Co)', type: ElementType.TASK, incomingFlows: ['12'], outgoingFlows: ['8'] },
            { id: 'Activity_1g33b4i', name: 'Accept offer (Ao)', type: ElementType.TASK, incomingFlows: ['15'], outgoingFlows: ['16'] },
            { id: 'Activity_0iyazhn', name: 'Approve and activate application (Aaa)', type: ElementType.TASK, incomingFlows: ['16'], outgoingFlows: ['17'] },
            { id: 'Activity_05537al', name: 'Decline offer (Do)', type: ElementType.TASK, incomingFlows: ['18'], outgoingFlows: ['19'] },
            { id: 'Activity_19r4cu3', name: 'Decline application (Da2)', type: ElementType.TASK, incomingFlows: ['19'], outgoingFlows: ['20'] },
            { id: 'Event_1bsroo5', name: 'Application finished (Af)', type: ElementType.END, incomingFlows: ['21'], outgoingFlows: [] },
            { id: 'Gateway_1o9s8fw_Flow_07cyta2', type: ElementType.XOR_SPLIT, incomingFlows: ['0'], outgoingFlows: ['1'] },
            { id: 'Gateway_1o9s8fw_Flow_1n5x723', type: ElementType.XOR_SPLIT, incomingFlows: ['0'], outgoingFlows: ['3'] },
            { id: 'Gateway_1rgq5gy', type: ElementType.AND_SPLIT, incomingFlows: ['4'], outgoingFlows: ['5', '7'] },
            { id: 'Gateway_1fwxfgu_Flow_0vs3ms0', type: ElementType.XOR_JOIN, incomingFlows: ['7'], outgoingFlows: ['9'] },
            { id: 'Gateway_1fwxfgu_Flow_1dlqvig', type: ElementType.XOR_JOIN, incomingFlows: ['8'], outgoingFlows: ['9'] },
            { id: 'Gateway_1way65i_Flow_0q0zlpw', type: ElementType.XOR_SPLIT, incomingFlows: ['11'], outgoingFlows: ['13'] },
            { id: 'Gateway_1way65i_Flow_0x7rbwv', type: ElementType.XOR_SPLIT, incomingFlows: ['11'], outgoingFlows: ['12'] },
            { id: 'Gateway_1nglicj', type: ElementType.AND_JOIN, incomingFlows: ['6', '13'], outgoingFlows: ['14'] },
            { id: 'Gateway_1vl4hvy_Flow_0oshibp', type: ElementType.XOR_SPLIT, incomingFlows: ['14'], outgoingFlows: ['15'] },
            { id: 'Gateway_1vl4hvy_Flow_1b9hzto', type: ElementType.XOR_SPLIT, incomingFlows: ['14'], outgoingFlows: ['18'] },
            { id: 'Gateway_1vzsa13_Flow_0ka5y4w', type: ElementType.XOR_JOIN, incomingFlows: ['2'], outgoingFlows: ['21'] },
            { id: 'Gateway_1vzsa13_Flow_03xp19s', type: ElementType.XOR_JOIN, incomingFlows: ['17'], outgoingFlows: ['21'] },
            { id: 'Gateway_1vzsa13_Flow_12yxkzr', type: ElementType.XOR_JOIN, incomingFlows: ['20'], outgoingFlows: ['21'] },
        ];
        return {

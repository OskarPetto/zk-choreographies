...
contract TerminationVerifier {
    ...
    uint256 constant ALPHA_X =
        13911764818934757268230219630591721679784411408638010980100112751360676840409;
    uint256 constant ALPHA_Y =
        12004972658399421711045601376948249587202496603343741914269747019720200563395;

    // Groth16 beta point in G2 in powers of i
    uint256 constant BETA_NEG_X_0 =
        13647539026566914255200255805071269484229604829916428926573666309449933423400;
    uint256 constant BETA_NEG_X_1 =
        12855728078137430120376342233002831130308762295301136541964218621308695114489;
    uint256 constant BETA_NEG_Y_0 =
        12812808367807051332257288123637864995900821731095629915156586999315594459504;
    uint256 constant BETA_NEG_Y_1 =
        21707323083587414273929632109528936342121347424636173759031626826741488215352;

    // Groth16 gamma point in G2 in powers of i
    uint256 constant GAMMA_NEG_X_0 =
        16447592813899771126781770389495005073651735302804186769378148311089826562760;
    uint256 constant GAMMA_NEG_X_1 =
        14037175089408645743569508795734967323624534849421085414558243573254557581361;
    uint256 constant GAMMA_NEG_Y_0 =
        3447425666484353823412949819465806964525761991340767337060420717827224853902;
    uint256 constant GAMMA_NEG_Y_1 =
        9443543928385738702739933637530363794210725355784011527065798780423545536985;

    // Groth16 delta point in G2 in powers of i
    uint256 constant DELTA_NEG_X_0 =
        21499225110899528214732773584626953142866221666172356272063246064820112228647;
    uint256 constant DELTA_NEG_X_1 =
        12313023597721994067975662034159399865928977671505799250367517325936703785712;
    uint256 constant DELTA_NEG_Y_0 =
        17166790629265496071955310860862410129766626702203548640189999137338895289216;
    uint256 constant DELTA_NEG_Y_1 =
        4867938053179805172909309830041784258572891409377558132970747953210123582446;

    // Constant and public input points
    uint256 constant CONSTANT_X =
        2687146236974929409501174117400558919090770594014362692479758842676358189286;
    uint256 constant CONSTANT_Y =
        11417927654161733365493253069366378920826915670679908987181819689422667763773;
    uint256 constant PUB_0_X =
        9443482645740158538833870641081852140345688517356160847243172937368094639530;
    uint256 constant PUB_0_Y =
        15160937903360478189095077720543808656681029792895086017832896994268466715090;
    uint256 constant PUB_1_X =
        527918590731488976198424784196588881896175230163607888694873166035353890468;
    uint256 constant PUB_1_Y =
        9777939244604077755489304190439599736778353167409503631339049270690571941023;

...
contract TerminationVerifier {
    ...
    uint256 constant ALPHA_X =
        15067781151597007340903745112858257413752423626253246593369018304537367649317;
    uint256 constant ALPHA_Y =
        12460586209099525235042913364745257103599257626099111402045953913997893320719;

    // Groth16 beta point in G2 in powers of i
    uint256 constant BETA_NEG_X_0 =
        759640426812242467902234625129431962926299162514843857552201815488582927384;
    uint256 constant BETA_NEG_X_1 =
        9274012086548867907478780899938266842819300334132757615685251380596336395562;
    uint256 constant BETA_NEG_Y_0 =
        8140597481417110571723901139331467545217372646170337622005249409616144394350;
    uint256 constant BETA_NEG_Y_1 =
        2403897253680644704627496466475035534332562513805291713912091079664457136899;

    // Groth16 gamma point in G2 in powers of i
    uint256 constant GAMMA_NEG_X_0 =
        18347746588831940138443931977259930080905259411408075658667094473788464218814;
    uint256 constant GAMMA_NEG_X_1 =
        5865302825393575975331894272874716832047613988139649488685695263401393998202;
    uint256 constant GAMMA_NEG_Y_0 =
        1556845406240637621610214221211356620990836947008659875028696259858632802025;
    uint256 constant GAMMA_NEG_Y_1 =
        5865327435561213179258654913207261001263449129444334885949162383205205765325;

    // Groth16 delta point in G2 in powers of i
    uint256 constant DELTA_NEG_X_0 =
        5089861615310893407754680483410547559294297711206130330432175261039637427311;
    uint256 constant DELTA_NEG_X_1 =
        9629267416552707734891209648658443593923194186510541732622092448670828650480;
    uint256 constant DELTA_NEG_Y_0 =
        17956462606919980796134773419634987308563598883380521337109240768211811508765;
    uint256 constant DELTA_NEG_Y_1 =
        21019428563099561659555313365976322451534255613438717248165884982175775490023;

    // Constant and public input points
    uint256 constant CONSTANT_X =
        12736776538198454785282827125188753575024778571163015747340619152032016435082;
    uint256 constant CONSTANT_Y =
        11946889650797460040130292361177369013053293048548965325307858914089593847234;
    uint256 constant PUB_0_X =
        11273815445019425270355192487902610087748194143762454536119614805486994719960;
    uint256 constant PUB_0_Y =
        7614644602562995354985508285091508658180452954653881241326483351988784257291;

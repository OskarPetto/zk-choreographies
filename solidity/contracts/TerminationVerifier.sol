...
contract TerminationVerifier {
    ...
    uint256 constant ALPHA_X =
        10345756904569279469535415385075022298961455408114867901359275372241446164045;
    uint256 constant ALPHA_Y =
        989685667849186149091169877325075245067952464596047563395836895929203869127;

    // Groth16 beta point in G2 in powers of i
    uint256 constant BETA_NEG_X_0 =
        8323848112468205728565141631761786632074855037865147116778363073391767425332;
    uint256 constant BETA_NEG_X_1 =
        1301738584921904463428014358674640549310631327777480656739745654905708285173;
    uint256 constant BETA_NEG_Y_0 =
        4529377795564247050278157744378997867477728687670340445467534990647975101911;
    uint256 constant BETA_NEG_Y_1 =
        21796718406199534840482880755619714148513795147544584998363811207438187847142;

    // Groth16 gamma point in G2 in powers of i
    uint256 constant GAMMA_NEG_X_0 =
        11568488290332420379691737040450678972065942331111846422266532500920802543108;
    uint256 constant GAMMA_NEG_X_1 =
        1788945971586680718311859445518725605629123344331828361842146638316538249274;
    uint256 constant GAMMA_NEG_Y_0 =
        17098113832036353417858997578824580805457366081489379728323010135097795660071;
    uint256 constant GAMMA_NEG_Y_1 =
        20286271111521930734766717857209408852441466166178725760816111076039832670770;

    // Groth16 delta point in G2 in powers of i
    uint256 constant DELTA_NEG_X_0 =
        11409699203286689503405757943300718036532618281948074140824776222621307932048;
    uint256 constant DELTA_NEG_X_1 =
        20903440484335384448503458292739522686840924688151212771027152594335539966876;
    uint256 constant DELTA_NEG_Y_0 =
        6482213654138345058224280358274757254926708191827501368284864267298849927662;
    uint256 constant DELTA_NEG_Y_1 =
        10597791856184631845652543480849290361996405914051529320775576253945308057440;

    // Constant and public input points
    uint256 constant CONSTANT_X =
        7676290533361694989534585800149218973810901571530971086286705663123895213897;
    uint256 constant CONSTANT_Y =
        19933644481501971887020895487749179982537711769869130927162916344800748307503;
    uint256 constant PUB_0_X =
        3171527365298212223547599090770179887792106103923492203045978471099712359194;
    uint256 constant PUB_0_Y =
        19773126615383662285902310945036382072950378599481735859255561272870874960421;
    uint256 constant PUB_1_X =
        12808991295134113282904892802077039197432381537785383422251827639404519203016;
    uint256 constant PUB_1_Y =
        14667394396848070110663517135963817252035956532834276813178135098419933981777;

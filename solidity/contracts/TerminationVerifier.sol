...
contract TerminationVerifier {
    ...
    uint256 constant ALPHA_X =
        5581270037480277301175753013615987788740964027843155617261691439972632478360;
    uint256 constant ALPHA_Y =
        19995365986734768198949196010203012333715156792078737308733631202173306176730;

    // Groth16 beta point in G2 in powers of i
    uint256 constant BETA_NEG_X_0 =
        10018309406373491371886926234184725990426646661607388650492972148382894692590;
    uint256 constant BETA_NEG_X_1 =
        18991206764760483200295641728025150076033552713252195836019193887012267751986;
    uint256 constant BETA_NEG_Y_0 =
        19541904874791423018388975095228214006014213496373620348421967559463561274589;
    uint256 constant BETA_NEG_Y_1 =
        7429057605574703068394661494440373543335690268638080704390264156413707001615;

    // Groth16 gamma point in G2 in powers of i
    uint256 constant GAMMA_NEG_X_0 =
        2222890185048195945879278530846801899147301896913570693629646045732148007873;
    uint256 constant GAMMA_NEG_X_1 =
        1596633131845974019387852738950661774878269579711111529559653600673024091181;
    uint256 constant GAMMA_NEG_Y_0 =
        18177876714960253836468091027732885297231379589372655412169627594768123417707;
    uint256 constant GAMMA_NEG_Y_1 =
        4536521296133608053754784813100222884721165987956149691690329161992867960206;

    // Groth16 delta point in G2 in powers of i
    uint256 constant DELTA_NEG_X_0 =
        15172826936187696200624645338668147451857840711544298348041354669441518027313;
    uint256 constant DELTA_NEG_X_1 =
        11131478998161530908056038372167333840507500240704839824261265174651165056954;
    uint256 constant DELTA_NEG_Y_0 =
        20208552671975564650797415629318079698701350230626106643957718787739826082127;
    uint256 constant DELTA_NEG_Y_1 =
        88781804118489201966921058703840397700077504202094570801721056136891461361;

    // Constant and public input points
    uint256 constant CONSTANT_X =
        2009188634627196080544884171989145313993175288526627735089052523638448938639;
    uint256 constant CONSTANT_Y =
        13030507651795435078505338718847485572302738396018804777929532430557523412109;
    uint256 constant PUB_0_X =
        8484447300797187453279598538937705531675332273135213419418216119029540401472;
    uint256 constant PUB_0_Y =
        21400569975154647563600014545653528899570182708372065360787722813637383388404;
    uint256 constant PUB_1_X =
        21421292419744302200636793832178774619120701723054553392399545799892631187757;
    uint256 constant PUB_1_Y =
        18199391540094999713833058991121991536361239862873400714015154178259096161450;

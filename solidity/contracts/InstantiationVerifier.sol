...
contract InstantiationVerifier {
    ...
    uint256 constant ALPHA_X =
        15190894667129986940746673215484104942746927345985155052624534457995769070786;
    uint256 constant ALPHA_Y =
        19947151264288518470653885909786667563526615794975915651565694737467292924358;

    // Groth16 beta point in G2 in powers of i
    uint256 constant BETA_NEG_X_0 =
        46374180100946955826969655526739441234517916572692370148821268459066036393;
    uint256 constant BETA_NEG_X_1 =
        8428855224441579674272598208571683612226009915302380928747111951810262442076;
    uint256 constant BETA_NEG_Y_0 =
        20070234309299983733314190586738041310731711151278764652028417741816741014585;
    uint256 constant BETA_NEG_Y_1 =
        8211251810792952442944665276858386434885893110340721025967835393066157467439;

    // Groth16 gamma point in G2 in powers of i
    uint256 constant GAMMA_NEG_X_0 =
        14986731620097471182965177209104394193269477584537497411632236789769160284784;
    uint256 constant GAMMA_NEG_X_1 =
        8456838296614298011562129668113901042886650584541375711646577220183215674558;
    uint256 constant GAMMA_NEG_Y_0 =
        7145745629213261031052703287240529255036331095394634150133025013246201003812;
    uint256 constant GAMMA_NEG_Y_1 =
        14031250244945889959793606219241201726749495273130698190275816007287826285311;

    // Groth16 delta point in G2 in powers of i
    uint256 constant DELTA_NEG_X_0 =
        2858665908383886884340786723547215760470264409330882595085341399919311343385;
    uint256 constant DELTA_NEG_X_1 =
        8536347466862431503531532779590142148538870637357541359747720563602388093137;
    uint256 constant DELTA_NEG_Y_0 =
        19513348022044223464575742552185586225050274786022672747698760836449449600725;
    uint256 constant DELTA_NEG_Y_1 =
        6096916831351345197022305395029241819911709603392042785087443452211925715764;

    // Constant and public input points
    uint256 constant CONSTANT_X =
        17696827739291795146441066969551201593948187441059783254071722272305803429434;
    uint256 constant CONSTANT_Y =
        7318592944150575545779661833305502102567134389396621945520434867038178478304;
    uint256 constant PUB_0_X =
        14348410503763407474706248643656158840277517261763566229428396124328876843364;
    uint256 constant PUB_0_Y =
        13077820535999599062479503171643314754674508088506805455538328243707579507825;

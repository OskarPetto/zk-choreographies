...
contract InstantiationVerifier {
    ...
    uint256 constant ALPHA_X =
        9645796452896396990589019887732098681630123396882969863039375852533675880265;
    uint256 constant ALPHA_Y =
        2521822100312581332427267712121660966510806088609242064928093689732912385116;

    // Groth16 beta point in G2 in powers of i
    uint256 constant BETA_NEG_X_0 =
        11659984626231428576846993193110267007520083270551847310550099207150304819893;
    uint256 constant BETA_NEG_X_1 =
        10624229750613256381680864099146887215022157125915309854296738663084499216881;
    uint256 constant BETA_NEG_Y_0 =
        10102225380501489425398280704207216897431623764442105623633449883485345429791;
    uint256 constant BETA_NEG_Y_1 =
        11054082008337116207146054349343821101530849447646197273454677471917066917463;

    // Groth16 gamma point in G2 in powers of i
    uint256 constant GAMMA_NEG_X_0 =
        7936203562677007929968539562351360556468575084752712389459948755686020780119;
    uint256 constant GAMMA_NEG_X_1 =
        6756679728848464273830769659950724212254331612002021734834399154796953808804;
    uint256 constant GAMMA_NEG_Y_0 =
        17028663717038164591256934376163547952019012438716255095048278632984005987367;
    uint256 constant GAMMA_NEG_Y_1 =
        5353072817376066562870730446859535791384567232081108819146727631059617238377;

    // Groth16 delta point in G2 in powers of i
    uint256 constant DELTA_NEG_X_0 =
        4854243815760664570191305674886870554907683460660321195666364642744964293916;
    uint256 constant DELTA_NEG_X_1 =
        6227495488090012292967610866358006203836210383919036300738176780632545758215;
    uint256 constant DELTA_NEG_Y_0 =
        11310129715327272181220764793854318142629344247701317408369582606091683204442;
    uint256 constant DELTA_NEG_Y_1 =
        13971182288107589361092381565055085641337118982052665352712827022908120040815;

    // Constant and public input points
    uint256 constant CONSTANT_X =
        4667969076055957782671219911282807897615918140384608357385422475716571692854;
    uint256 constant CONSTANT_Y =
        14013387693763972000597056236458944408850998891759360859351367844922880176036;
    uint256 constant PUB_0_X =
        21183836700686992107310476748242762255337522684763953862517607834874558893905;
    uint256 constant PUB_0_Y =
        11637070166345126719931826698689494578634174881254249983366895880663870279279;
    uint256 constant PUB_1_X =
        4615164328672759425793304492940055568990865833843466999192673661578713205543;
    uint256 constant PUB_1_Y =
        3307766510279696507897035198665348014927427061244546460537862146688049519362;

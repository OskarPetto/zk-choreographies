...
contract InstantiationVerifier {
    ...
    uint256 constant ALPHA_X =
        13784591378853884821244703054677708951166611927171188940154154357168000738965;
    uint256 constant ALPHA_Y =
        20290624337589653118191942981509586956888700467765128457203651636161332740994;

    // Groth16 beta point in G2 in powers of i
    uint256 constant BETA_NEG_X_0 =
        6644950570046466536268345926155268720401219607975513452625701321287166102337;
    uint256 constant BETA_NEG_X_1 =
        21677730925568947696584608058744729014936798038372922182021904569352398002960;
    uint256 constant BETA_NEG_Y_0 =
        10012297776982407604906919119087782658849374339083160352126699180477317621531;
    uint256 constant BETA_NEG_Y_1 =
        2033894353878442916332255113031773697835357479190276046507974907018480448994;

    // Groth16 gamma point in G2 in powers of i
    uint256 constant GAMMA_NEG_X_0 =
        7283431379683308075338305309814749618822128398055560576449592709704890025448;
    uint256 constant GAMMA_NEG_X_1 =
        15556006901817946575883446085040703659234765317144934521084049140973623113343;
    uint256 constant GAMMA_NEG_Y_0 =
        19157368383641022716420836780300636421307771616566920956211612781119736252307;
    uint256 constant GAMMA_NEG_Y_1 =
        11423906240719431831788799084748465086091198648963037796833483122523251241151;

    // Groth16 delta point in G2 in powers of i
    uint256 constant DELTA_NEG_X_0 =
        11409799879063623733464301377477852877186908904283724014207133663523084530636;
    uint256 constant DELTA_NEG_X_1 =
        15424643462553412175568005733820633967770318789388237419696313976110235053677;
    uint256 constant DELTA_NEG_Y_0 =
        2649877409031012099478814605341103368090122286995183728131886617522297451289;
    uint256 constant DELTA_NEG_Y_1 =
        15839176662483646551734023086304198369247491914910946929140798548984423440147;

    // Constant and public input points
    uint256 constant CONSTANT_X =
        7242243237715787290293730965041819061456865394562296318672354557980964190117;
    uint256 constant CONSTANT_Y =
        16706201957371912577948368515267472650703982669459718021086100045454804515808;
    uint256 constant PUB_0_X =
        9499189878027934215460536291907761618443253252843576386642375825252721190628;
    uint256 constant PUB_0_Y =
        3402927524670417302272298711357638121560746915913430742055160034159699852892;
    uint256 constant PUB_1_X =
        3504600412728993063548897106815130663321394579424201930598369924145710538930;
    uint256 constant PUB_1_Y =
        20333328373001723968574727174416067782896034066415160579187264057874034628127;

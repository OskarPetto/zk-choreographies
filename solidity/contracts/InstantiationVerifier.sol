...
contract InstantiationVerifier {
    ...
    uint256 constant ALPHA_X =
        6474371795649713254570920418032171056605207987371238383367552819062122407027;
    uint256 constant ALPHA_Y =
        19285332647772937517283861330701968224914939168015971187749272821141533015243;

    // Groth16 beta point in G2 in powers of i
    uint256 constant BETA_NEG_X_0 =
        4598607176444435109494118334823561316300388512887242822397854421123107367478;
    uint256 constant BETA_NEG_X_1 =
        9025673388753530658680547614793590047355241962497994820190953596187174662618;
    uint256 constant BETA_NEG_Y_0 =
        3462926419905827771803955107142710989089245002213947818266937769594048158300;
    uint256 constant BETA_NEG_Y_1 =
        12777715914678573147534515409476215216089116974624709847125758790114639965853;

    // Groth16 gamma point in G2 in powers of i
    uint256 constant GAMMA_NEG_X_0 =
        21801798951773700510389140115763330788345881228426890078655452630555808107783;
    uint256 constant GAMMA_NEG_X_1 =
        18800210459769658177124392921012290474276509234202081198036877964908097170135;
    uint256 constant GAMMA_NEG_Y_0 =
        3524313386965525649799240004375757503448229832287091261156956797710768140643;
    uint256 constant GAMMA_NEG_Y_1 =
        2087373957591223126162547634649816273946307474985448956770012611488360678944;

    // Groth16 delta point in G2 in powers of i
    uint256 constant DELTA_NEG_X_0 =
        13220118242303569132645998236117954803591112371465567781686465301126321930602;
    uint256 constant DELTA_NEG_X_1 =
        21308481669501053459109799929382771455650761704777751515754781997521173078923;
    uint256 constant DELTA_NEG_Y_0 =
        20731227026045358656876944898837311232549141261439775256481284124288120859992;
    uint256 constant DELTA_NEG_Y_1 =
        12672271167950659075601532074038416387658293507169828861992457670804005155199;

    // Constant and public input points
    uint256 constant CONSTANT_X =
        7635395489370535125023994846597815176562204132895421880205928408745139964488;
    uint256 constant CONSTANT_Y =
        2875469347230110188202983511373923563271355638546026693593744800840937284264;
    uint256 constant PUB_0_X =
        1186501408148952278397259429319576746749302132998887122142740327962862698201;
    uint256 constant PUB_0_Y =
        9680633406158394591108058265666140361009641293850903066184590139667582688750;
    uint256 constant PUB_1_X =
        16810156062375309712134703561561532480052556695091173575522251540119865806575;
    uint256 constant PUB_1_Y =
        12245264238259458044011222641776145199175122527887203925480477622372940544544;

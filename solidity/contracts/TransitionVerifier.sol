...
contract TransitionVerifier {
    ...
    uint256 constant ALPHA_X =
        16211499579108929384020537351940507694156331192307753210391609504693660184009;
    uint256 constant ALPHA_Y =
        4240986958922305272776022683369781316077379752944269051038048335617412588584;

    // Groth16 beta point in G2 in powers of i
    uint256 constant BETA_NEG_X_0 =
        15171787162148483886672262787033764896684932089707019546272310564699003252477;
    uint256 constant BETA_NEG_X_1 =
        19739881905745790017184082801752734128270718520135067081075532712433390187516;
    uint256 constant BETA_NEG_Y_0 =
        8833131295964253215780905900362168640531842972474950877347036468404971093236;
    uint256 constant BETA_NEG_Y_1 =
        9632687915252123203090251003894384440926194354459562118432528444352785179564;

    // Groth16 gamma point in G2 in powers of i
    uint256 constant GAMMA_NEG_X_0 =
        9576042659386529395890409563841803662640835711572193235882997260049496277348;
    uint256 constant GAMMA_NEG_X_1 =
        11096778993996864970988377967947478521269460323296527883522951730385506204446;
    uint256 constant GAMMA_NEG_Y_0 =
        14136027674212457226903117627917726451334301999949770355192037801631895049782;
    uint256 constant GAMMA_NEG_Y_1 =
        5778194752971199274049701733559970157081643609111279429429909219224923355538;

    // Groth16 delta point in G2 in powers of i
    uint256 constant DELTA_NEG_X_0 =
        15491350048387555311492811868793571759732717359381023520424482586314595312504;
    uint256 constant DELTA_NEG_X_1 =
        14232625485422666161534185623411053262486526738147258547281835714907925860219;
    uint256 constant DELTA_NEG_Y_0 =
        1811977041516567197727694736528668981461454147149198070627107076018794252282;
    uint256 constant DELTA_NEG_Y_1 =
        17723532271535077547659989713463364389982028096164276574513135560337626823812;

    // Constant and public input points
    uint256 constant CONSTANT_X =
        576761838603393400466680808731152294968195282290509611246158189409516394025;
    uint256 constant CONSTANT_Y =
        5678262501474806610941492309668259796871776507726338727851980031564757268804;
    uint256 constant PUB_0_X =
        10354233445022994690222063678550501670783252519077962862439719844506847839754;
    uint256 constant PUB_0_Y =
        17696994189814108267259019877640998570962089671040527840919736505827704602823;
    uint256 constant PUB_1_X =
        21080749058444630021208044885723182265781114121592273991240982235658708156066;
    uint256 constant PUB_1_Y =
        3430592351526834599083867317890255658895985071746491613351992035089340407752;
    uint256 constant PUB_2_X =
        20790813196787141204653533322119819255077391668977966474414997225594637064139;
    uint256 constant PUB_2_Y =
        15785399951686711014147858992163794195924554708967029372511364700791026961019;

...
contract TransitionVerifier {
    ...
    uint256 constant ALPHA_X =
        15751574441473262615041374816252787362025670766742996820939467144498689554398;
    uint256 constant ALPHA_Y =
        21755784114770472420205703133454318010328125724923411478721701268888545636776;

    // Groth16 beta point in G2 in powers of i
    uint256 constant BETA_NEG_X_0 =
        12858487854268979646189882595395584758794883991569444538809294260007145995162;
    uint256 constant BETA_NEG_X_1 =
        19672724451025615308909277598369709317993760592322439470015457661372073889980;
    uint256 constant BETA_NEG_Y_0 =
        4936976585692044183786666528001371753659612463073223583898343341909194657696;
    uint256 constant BETA_NEG_Y_1 =
        2131170374411524071731022746974439168829932230546950443095728163126017838161;

    // Groth16 gamma point in G2 in powers of i
    uint256 constant GAMMA_NEG_X_0 =
        11641263514348404351385435302092252834637977051402975512523594111115952651863;
    uint256 constant GAMMA_NEG_X_1 =
        16642326783644559053130118433363163479518021270306753783360227513266573999603;
    uint256 constant GAMMA_NEG_Y_0 =
        4646150635258453550541237453244845534892446068204720506308548753020510322169;
    uint256 constant GAMMA_NEG_Y_1 =
        13425553278886881097949790793191620624986483025587089272849270500314819865098;

    // Groth16 delta point in G2 in powers of i
    uint256 constant DELTA_NEG_X_0 =
        17626243377627017379842366531429845529908502344141128006829648747465919072284;
    uint256 constant DELTA_NEG_X_1 =
        7989235502569461477609554815268557785628451557244071998877743469411097382675;
    uint256 constant DELTA_NEG_Y_0 =
        7230250458148914683277069085978444071702167135956323086233757609320650882707;
    uint256 constant DELTA_NEG_Y_1 =
        20257429803932742030297460447298384890483692652723750989489235441176500923761;

    // Constant and public input points
    uint256 constant CONSTANT_X =
        3550059599416652750262593991760441367565180095473359118030538031898395172314;
    uint256 constant CONSTANT_Y =
        17524281064233081828912212880835613346361300325210369881557202660765971460606;
    uint256 constant PUB_0_X =
        1662261216382895993925759675323900873419663903446162756391293976573457165810;
    uint256 constant PUB_0_Y =
        9491074356643794935515714301283228953525503677603978149961312965213658704449;
    uint256 constant PUB_1_X =
        6957408485613955630586348062651737954731594808825499530071209683721023362504;
    uint256 constant PUB_1_Y =
        7480847485221675656119810077257370739828253920268416925344802388213927623388;
    uint256 constant PUB_2_X =
        11672721296520632890007843696436240866317612082256350246350617456252595871452;
    uint256 constant PUB_2_Y =
        11824645103120206292280541059013017030807267319352216474120082262125516352700;

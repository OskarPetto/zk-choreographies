...
contract TransitionVerifier {
    ...
    uint256 constant ALPHA_X =
        11628380637364546277801723001332054206818025221610361008569971625748774429089;
    uint256 constant ALPHA_Y =
        7603498995574820640862519939753332480666904586430255072008028458505866838696;

    // Groth16 beta point in G2 in powers of i
    uint256 constant BETA_NEG_X_0 =
        5375216147570844480515811127827442306334172413607465156397298078510200405207;
    uint256 constant BETA_NEG_X_1 =
        1891296886898870142463712904868797168490447117432306610131768780511568172815;
    uint256 constant BETA_NEG_Y_0 =
        5868221476748961790332641371548540322670458977442303998328319492204947324666;
    uint256 constant BETA_NEG_Y_1 =
        21266180366346943852756597544758649270111618716107662707704024545441845276696;

    // Groth16 gamma point in G2 in powers of i
    uint256 constant GAMMA_NEG_X_0 =
        15898295194344159600865146571211110785823278601066545475161273904615365944126;
    uint256 constant GAMMA_NEG_X_1 =
        13626619227875683668105553013675336263672121462182353023796561363564466886337;
    uint256 constant GAMMA_NEG_Y_0 =
        7005644144247826533931726620303558286237213465764847493209241893845622483157;
    uint256 constant GAMMA_NEG_Y_1 =
        21112643183498406601915770820162379991110604939566344745441208689788288555867;

    // Groth16 delta point in G2 in powers of i
    uint256 constant DELTA_NEG_X_0 =
        11247104477989709476981704685653697916435056325642325995899040264711891304710;
    uint256 constant DELTA_NEG_X_1 =
        21842612138497300353320024814169216383238695091038560631058653850558684398224;
    uint256 constant DELTA_NEG_Y_0 =
        10551791306212994520756738236414539562284939405138607556432578380704796743224;
    uint256 constant DELTA_NEG_Y_1 =
        8097089766242680639199752440338656999064628330396238843222257465893565717235;

    // Constant and public input points
    uint256 constant CONSTANT_X =
        1975530333509913878820385552793268636296839134603584890050860413665184880301;
    uint256 constant CONSTANT_Y =
        3125710867497666204748317294922925993338461511001394230090490457773741697371;
    uint256 constant PUB_0_X =
        18639997084470029791574211349131027983201154156074263514390322566055614445727;
    uint256 constant PUB_0_Y =
        12271692499419172040894988151727734425864546185806245504296755795017708983597;
    uint256 constant PUB_1_X =
        5308695970646211926730969044640278529154052176388360112641615895598812237447;
    uint256 constant PUB_1_Y =
        2583819334691075017685964384186210402458147844120587935004606608151107980030;
    uint256 constant PUB_2_X =
        17048473261848301706269170885506670947361809973647862084543673658546854691850;
    uint256 constant PUB_2_Y =
        358809655951634648917039591468958020424944716088127398239581988336702366545;

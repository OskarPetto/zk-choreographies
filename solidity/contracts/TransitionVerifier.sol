...
contract TransitionVerifier {
    ...
    uint256 constant ALPHA_X =
        16691959724959536311076712539132862064226069951380437129848448639028217026558;
    uint256 constant ALPHA_Y =
        10829053928557722206019581125306343779737531003917545585715925845365981545445;

    // Groth16 beta point in G2 in powers of i
    uint256 constant BETA_NEG_X_0 =
        13021652807745250897966721133906220975766507137149049112869689339799236840493;
    uint256 constant BETA_NEG_X_1 =
        3993452478056786720253255004427159073416351089432603396413950194980004279516;
    uint256 constant BETA_NEG_Y_0 =
        2564296239722134582753007985611994576041041931088652767805409600506806266826;
    uint256 constant BETA_NEG_Y_1 =
        1710868072381232052358058598960632807788659386630937632398118105092510039717;

    // Groth16 gamma point in G2 in powers of i
    uint256 constant GAMMA_NEG_X_0 =
        19513092100267911028208394601817109907217399454938158643110462870632433253877;
    uint256 constant GAMMA_NEG_X_1 =
        18234935469729805068280820743091109077430882881352248567045132341774010501717;
    uint256 constant GAMMA_NEG_Y_0 =
        7429812271248521502624396883245477210240703072545823094706334158811241765943;
    uint256 constant GAMMA_NEG_Y_1 =
        12299812749298975749152260814123512216674975379678617401883407940799831540564;

    // Groth16 delta point in G2 in powers of i
    uint256 constant DELTA_NEG_X_0 =
        4734537408096842898540078799409533974399638495107920380214355200928163138771;
    uint256 constant DELTA_NEG_X_1 =
        12621857917532285983915563105779690254695555329238494865881914370449375737672;
    uint256 constant DELTA_NEG_Y_0 =
        15515790922506722238011254208127534766824508479738228290686605815417879569333;
    uint256 constant DELTA_NEG_Y_1 =
        16754546054724955995918716612610912874055509146232237462894071624032093199010;

    // Constant and public input points
    uint256 constant CONSTANT_X =
        8550739722857197205169052430510448979658835500570172826694556131121694348515;
    uint256 constant CONSTANT_Y =
        886724201530670401607365551101265689808817923613254659708381545579362631227;
    uint256 constant PUB_0_X =
        16119071302108371137123166264623115400695185824250924076236613628803839953641;
    uint256 constant PUB_0_Y =
        11248836055689253237864185658880280737545675086478360687598959500661854371295;
    uint256 constant PUB_1_X =
        17688710052206419747900474726828944146174679685521714689312923532288367280788;
    uint256 constant PUB_1_Y =
        1512431263900717532744225437583186491952947359555090663096874688015262543826;
